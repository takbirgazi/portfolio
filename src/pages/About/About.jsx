...
const About = () => {
    return (
        <div className="bg-gray-300 py-10" id="about">
            ...
            <p className="text-center">I never sleep when I am tired, but I will sleep only when I am Done!</p>
            <div className="w-11/12 mx-auto my-5 p-5">
                <div className="flex mx-auto items-center gap-1">
                    ...
                    <div className="flex-1">
                        <p>
                            Welcome to my website! I am Takbir Gazi, a web developer skilled in HTML, CSS, Tailwind CSS, React.js, MongoDB, Firebase, Express.js, MySQLi, and PHP. I create dynamic and responsive web applications, focusing on high-quality and efficient solutions. Explore my portfolio and contact me to bring your web projects to life!
                        </p>
