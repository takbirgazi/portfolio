...
const Contact = () => {
    ...
    return (
        <div className="bg-gray-300 py-10" id="contact">
            ...
            <p className="text-center">If you have any query Please messages</p>
                ...
                <form onSubmit={contactHandler} className="flex flex-col gap-5">
                    <div className="flex flex-col md:flex-row items-center justify-between gap-2">
                        <div className="flex flex-col md:w-1/2 w-full">
                            ...
                            <input type="text" name="name" placeholder="Write Your Name" className="border rounded p-2 outline-none" required />
                        </div>
                        <div className="flex flex-col md:w-1/2 w-full">
                            <label htmlFor="name">Email</label>
                            <input type="email" name="email" placeholder="Write Your Email" className="border rounded p-2 outline-none" required />
                        </div>
                    </div>
                    <div className="flex flex-col">
                        <label htmlFor="name">Message</label>
                        <textarea name="message" rows="5" cols="30" className="border rounded p-2 outline-none" placeholder="Write your message" required></textarea>
                    </div>
                    <div>
